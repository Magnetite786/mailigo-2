    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 max-w-4xl mx-auto leading-tight">
            Send Bulk Emails <span className="gradient-text">Effortlessly</span> Using Your Gmail Account
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/signup">
              <Button className="gradient-bg text-lg py-6 px-8 rounded-lg shadow-lg">
                Get Started
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-br from-brand-purple/10 to-brand-lightPurple/10 p-2 md:p-8 rounded-xl shadow-xl">
            <div className="bg-card border rounded-lg shadow-sm overflow-hidden">
              <div className="bg-primary/5 p-4 border-b flex items-center space-x-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <div className="bg-primary/20 text-primary text-xs px-3 py-1 rounded-full">user1@example.com</div>
                        <div className="bg-primary/20 text-primary text-xs px-3 py-1 rounded-full">user2@example.com</div>
                        <div className="bg-primary/20 text-primary text-xs px-3 py-1 rounded-full">user3@example.com</div>
                        <div className="bg-primary/20 text-primary text-xs px-3 py-1 rounded-full">+5 more</div>
                      </div>
                      <div className="h-10 bg-muted rounded flex items-center justify-between px-3">
                        <span className="text-xs text-muted-foreground">Upload CSV/Excel</span>
                        <div className="w-24 bg-background rounded-sm h-6"></div>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
